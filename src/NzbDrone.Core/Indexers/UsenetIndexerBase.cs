...
namespace NzbDrone.Core.Indexers
{
        ...
        where TSettings : IIndexerSettings, new()
    {
        ...
        protected UsenetIndexerBase(IIndexerHttpClient httpClient, IEventAggregator eventAggregator, IIndexerStatusService indexerStatusService, IConfigService configService, IValidateNzbs nzbValidationService, Logger logger, ICacheManager cacheManager)
